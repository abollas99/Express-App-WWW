...
exports.get_landing = (req, res, next) =>
  res.render('landing', { 
    title: 'Anthonys Final Project for CPS3500' 
});
...
exports.show_leads = (req, res, next) => { models.Lead.findAll().then(leads => {
  res.render('landing', {title: 'Anthonys Final Project for CPS3500', leads: leads });//passing any object to the view
  })
}
